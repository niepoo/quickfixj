...
public class OrderCancelReplaceRequest extends Message {
	...
	public OrderCancelReplaceRequest(quickfix.field.OrigClOrdID origClOrdID, quickfix.field.ClOrdID clOrdID, quickfix.field.HandlInst handlInst, quickfix.field.Symbol symbol, quickfix.field.Side side, quickfix.field.OrdType ordType) {
		this();
