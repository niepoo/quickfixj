...
public class NewOrderSingle extends Message {
	...
	public NewOrderSingle(quickfix.field.ClOrdID clOrdID, quickfix.field.HandlInst handlInst, quickfix.field.Symbol symbol, quickfix.field.Side side, quickfix.field.OrdType ordType) {
		this();
		setField(clOrdID);
		setField(handlInst);
		setField(symbol);
