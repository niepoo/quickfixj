...
public class QuoteStatusReport extends Message {
	...
	public void set(quickfix.fix50.component.LegQuotStatGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.LegQuotStatGrp get(quickfix.fix50.component.LegQuotStatGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.LegQuotStatGrp getLegQuotStatGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.LegQuotStatGrp());
	}
