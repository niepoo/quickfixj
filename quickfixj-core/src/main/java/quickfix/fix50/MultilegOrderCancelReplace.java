...
public class MultilegOrderCancelReplace extends Message {
	...
	public MultilegOrderCancelReplace(quickfix.field.OrigClOrdID origClOrdID, quickfix.field.ClOrdID clOrdID, quickfix.field.Side side, quickfix.field.TransactTime transactTime, quickfix.field.OrdType ordType) {
		this();
	...
	public void set(quickfix.fix50.component.PreAllocMlegGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.PreAllocMlegGrp get(quickfix.fix50.component.PreAllocMlegGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.PreAllocMlegGrp getPreAllocMlegGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.PreAllocMlegGrp());
	}
	...
	public quickfix.fix50.component.NestedParties3 get(quickfix.fix50.component.NestedParties3 component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.NestedParties3 getNestedParties3() throws FieldNotFound {
		return get(new quickfix.fix50.component.NestedParties3());
	}
	...
	public quickfix.fix50.component.NstdPtys3SubGrp getNstdPtys3SubGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.NstdPtys3SubGrp());
	}
	...
	public quickfix.fix50.component.TrdgSesGrp get(quickfix.fix50.component.TrdgSesGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.TrdgSesGrp getTrdgSesGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.TrdgSesGrp());
	}
	...
	public void set(quickfix.fix50.component.LegOrdGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.LegOrdGrp get(quickfix.fix50.component.LegOrdGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.LegOrdGrp getLegOrdGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.LegOrdGrp());
	}
