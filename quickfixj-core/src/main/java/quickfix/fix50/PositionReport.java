...
public class PositionReport extends Message {
	...
	public void set(quickfix.fix50.component.PosUndInstrmtGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.PosUndInstrmtGrp get(quickfix.fix50.component.PosUndInstrmtGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.PosUndInstrmtGrp getPosUndInstrmtGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.PosUndInstrmtGrp());
	}
	...
	public static class NoUnderlyings extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {311, 312, 309, 305, 457, 462, 463, 310, 763, 313, 542, 241, 242, 243, 244, 245, 246, 256, 595, 592, 593, 594, 247, 316, 941, 317, 436, 435, 308, 306, 362, 363, 307, 364, 365, 877, 878, 318, 879, 810, 882, 883, 884, 885, 886, 887, 972, 975, 973, 974, 998, 1000, 1038, 1058, 1039, 1044, 1045, 1046, 732, 733, 984, 1037, 0};
	...
	public quickfix.fix50.component.UnderlyingAmount get(quickfix.fix50.component.UnderlyingAmount component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.UnderlyingAmount getUnderlyingAmount() throws FieldNotFound {
		return get(new quickfix.fix50.component.UnderlyingAmount());
	}
	...
	public quickfix.fix50.component.PositionQty get(quickfix.fix50.component.PositionQty component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.PositionQty getPositionQty() throws FieldNotFound {
		return get(new quickfix.fix50.component.PositionQty());
	}
	...
	public static class NoPositions extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {703, 704, 705, 706, 539, 976, 0};
