...
public class NewOrderList extends Message {
	...
	public void set(quickfix.fix50.component.ListOrdGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.ListOrdGrp get(quickfix.fix50.component.ListOrdGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.ListOrdGrp getListOrdGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.ListOrdGrp());
	}
	...
	public quickfix.fix50.component.PreAllocGrp getPreAllocGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.PreAllocGrp());
	}
