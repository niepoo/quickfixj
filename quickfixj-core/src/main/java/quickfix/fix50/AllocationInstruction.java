...
public class AllocationInstruction extends Message {
	...
	public AllocationInstruction(quickfix.field.AllocID allocID, quickfix.field.AllocTransType allocTransType, quickfix.field.AllocType allocType, quickfix.field.Side side, quickfix.field.Quantity quantity, quickfix.field.TradeDate tradeDate) {
		this();
		setField(allocID);
