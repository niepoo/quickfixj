...
public class QuoteRequest extends Message {
	...
	public void set(quickfix.fix50.component.QuotReqGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.QuotReqGrp get(quickfix.fix50.component.QuotReqGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.QuotReqGrp getQuotReqGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.QuotReqGrp());
	}
	...
	public static class NoRelatedSym extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {55, 65, 48, 22, 454, 460, 461, 167, 762, 200, 541, 224, 225, 239, 226, 227, 228, 255, 543, 470, 471, 472, 240, 202, 947, 206, 231, 223, 207, 106, 348, 349, 107, 350, 351, 691, 667, 875, 876, 864, 873, 874, 965, 966, 1049, 967, 968, 969, 970, 971, 1018, 996, 997, 1079, 913, 914, 915, 918, 788, 916, 917, 919, 898, 711, 140, 303, 537, 336, 625, 229, 54, 854, 38, 152, 516, 468, 469, 63, 64, 193, 192, 15, 232, 1, 660, 581, 555, 735, 692, 40, 62, 126, 60, 218, 220, 221, 222, 662, 663, 699, 761, 423, 44, 640, 235, 236, 701, 696, 697, 698, 453, 0};
