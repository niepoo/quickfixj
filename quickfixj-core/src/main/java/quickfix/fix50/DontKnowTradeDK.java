...
public class DontKnowTradeDK extends Message {
	...
	public DontKnowTradeDK(quickfix.field.OrderID orderID, quickfix.field.ExecID execID, quickfix.field.DKReason dKReason, quickfix.field.Side side) {
		this();
		setField(orderID);
		setField(execID);
		setField(dKReason);
