...
public class DerivativeSecurityList extends Message {
	...
	public void set(quickfix.fix50.component.RelSymDerivSecGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.RelSymDerivSecGrp get(quickfix.fix50.component.RelSymDerivSecGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}
	...
	public static class NoRelatedSym extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {55, 65, 48, 22, 454, 460, 461, 167, 762, 200, 541, 224, 225, 239, 226, 227, 228, 255, 543, 470, 471, 472, 240, 202, 947, 206, 231, 223, 207, 106, 348, 349, 107, 350, 351, 691, 667, 875, 876, 864, 873, 874, 965, 966, 1049, 967, 968, 969, 970, 971, 1018, 996, 997, 1079, 15, 827, 668, 869, 870, 555, 336, 625, 58, 354, 355, 0};
