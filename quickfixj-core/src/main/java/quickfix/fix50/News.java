...
public class News extends Message {
	...
	public void set(quickfix.fix50.component.InstrmtGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.InstrmtGrp get(quickfix.fix50.component.InstrmtGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.InstrmtGrp getInstrmtGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.InstrmtGrp());
	}
	...
	public void set(quickfix.fix50.component.LinesOfTextGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.LinesOfTextGrp get(quickfix.fix50.component.LinesOfTextGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.LinesOfTextGrp getLinesOfTextGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.LinesOfTextGrp());
	}
