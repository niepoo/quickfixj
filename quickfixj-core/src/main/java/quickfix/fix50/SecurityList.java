...
public class SecurityList extends Message {
	...
	public void set(quickfix.fix50.component.SecListGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.SecListGrp get(quickfix.fix50.component.SecListGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.SecListGrp getSecListGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.SecListGrp());
	}
	...
	public static class NoRelatedSym extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {55, 65, 48, 22, 454, 460, 461, 167, 762, 200, 541, 224, 225, 239, 226, 227, 228, 255, 543, 470, 471, 472, 240, 202, 947, 206, 231, 223, 207, 106, 348, 349, 107, 350, 351, 691, 667, 875, 876, 864, 873, 874, 965, 966, 1049, 967, 968, 969, 970, 971, 1018, 996, 997, 1079, 668, 869, 870, 913, 914, 915, 918, 788, 916, 917, 919, 898, 711, 15, 232, 555, 218, 220, 221, 222, 662, 663, 699, 761, 235, 236, 701, 696, 697, 698, 561, 562, 336, 625, 827, 58, 354, 355, 0};
	...
	public void set(quickfix.fix50.component.InstrmtLegSecListGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.InstrmtLegSecListGrp get(quickfix.fix50.component.InstrmtLegSecListGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.InstrmtLegSecListGrp getInstrmtLegSecListGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.InstrmtLegSecListGrp());
	}
