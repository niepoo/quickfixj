...
public class TradeCaptureReport extends Message {
	...
	public TradeCaptureReport(quickfix.field.LastQty lastQty, quickfix.field.LastPx lastPx, quickfix.field.TradeDate tradeDate) {
		this();
		setField(lastQty);
		setField(lastPx);
		setField(tradeDate);
	...
	public void set(quickfix.fix50.component.TrdInstrmtLegGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.TrdInstrmtLegGrp get(quickfix.fix50.component.TrdInstrmtLegGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.TrdInstrmtLegGrp getTrdInstrmtLegGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.TrdInstrmtLegGrp());
	}
	...
	public static class NoLegs extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {600, 601, 602, 603, 604, 607, 608, 609, 764, 610, 611, 248, 249, 250, 251, 252, 253, 257, 599, 596, 597, 598, 254, 612, 942, 613, 614, 615, 616, 617, 618, 619, 620, 621, 622, 623, 624, 556, 740, 739, 955, 956, 999, 1001, 687, 690, 683, 564, 565, 539, 654, 566, 587, 588, 637, 990, 675, 1073, 1074, 1075, 0};
	...
	public void set(quickfix.fix50.component.TrdCapRptSideGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.TrdCapRptSideGrp get(quickfix.fix50.component.TrdCapRptSideGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.TrdCapRptSideGrp getTrdCapRptSideGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.TrdCapRptSideGrp());
	}
	...
	public static class NoSides extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {54, 37, 198, 11, 526, 66, 453, 1, 660, 581, 81, 575, 576, 578, 579, 821, 15, 376, 377, 528, 529, 582, 40, 18, 483, 336, 625, 943, 12, 13, 479, 497, 157, 230, 158, 159, 738, 920, 921, 922, 238, 237, 118, 119, 120, 155, 156, 77, 58, 354, 355, 752, 518, 232, 136, 825, 826, 591, 70, 78, 1009, 1005, 1006, 1007, 83, 1008, 1016, 19, 1093, 1072, 1057, 1139, 0};
	...
	public quickfix.fix50.component.TrdAllocGrp getTrdAllocGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.TrdAllocGrp());
	}
	...
	public quickfix.fix50.component.SideTrdRegTS getSideTrdRegTS() throws FieldNotFound {
		return get(new quickfix.fix50.component.SideTrdRegTS());
	}
	...
	public void set(quickfix.fix50.component.RootParties component) {
		setComponent(component);
	}
	...
	public quickfix.fix50.component.RootParties getRootParties() throws FieldNotFound {
		return get(new quickfix.fix50.component.RootParties());
	}
	...
	public quickfix.fix50.component.RootSubParties get(quickfix.fix50.component.RootSubParties component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.RootSubParties getRootSubParties() throws FieldNotFound {
		return get(new quickfix.fix50.component.RootSubParties());
	}
