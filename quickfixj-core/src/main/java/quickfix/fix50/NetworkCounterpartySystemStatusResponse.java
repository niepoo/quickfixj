...
public class NetworkCounterpartySystemStatusResponse extends Message {
	...
	public NetworkCounterpartySystemStatusResponse(quickfix.field.NetworkStatusResponseType networkStatusResponseType, quickfix.field.NetworkResponseID networkResponseID) {
		this();
	...
	public void set(quickfix.fix50.component.CompIDStatGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.CompIDStatGrp get(quickfix.fix50.component.CompIDStatGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.CompIDStatGrp getCompIDStatGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.CompIDStatGrp());
	}
