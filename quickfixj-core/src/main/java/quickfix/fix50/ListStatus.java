...
public class ListStatus extends Message {
	...
	public void set(quickfix.fix50.component.OrdListStatGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.OrdListStatGrp get(quickfix.fix50.component.OrdListStatGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.OrdListStatGrp getOrdListStatGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.OrdListStatGrp());
	}
