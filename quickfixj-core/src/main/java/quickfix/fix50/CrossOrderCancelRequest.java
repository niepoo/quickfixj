...
public class CrossOrderCancelRequest extends Message {
	...
	public quickfix.fix50.component.SideCrossOrdCxlGrp get(quickfix.fix50.component.SideCrossOrdCxlGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.SideCrossOrdCxlGrp getSideCrossOrdCxlGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.SideCrossOrdCxlGrp());
	}
