...
public class RequestForPositionsAck extends Message {
	...
	public RequestForPositionsAck(quickfix.field.PosMaintRptID posMaintRptID, quickfix.field.PosReqResult posReqResult, quickfix.field.PosReqStatus posReqStatus) {
		this();
