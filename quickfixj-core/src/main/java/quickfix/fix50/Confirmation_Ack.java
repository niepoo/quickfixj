...
public class Confirmation_Ack extends Message {
	...
	public Confirmation_Ack(quickfix.field.ConfirmID confirmID, quickfix.field.TradeDate tradeDate, quickfix.field.TransactTime transactTime, quickfix.field.AffirmStatus affirmStatus) {
		this();
		setField(confirmID);
		setField(tradeDate);
