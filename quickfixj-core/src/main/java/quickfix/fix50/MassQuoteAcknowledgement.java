...
public class MassQuoteAcknowledgement extends Message {
	...
	public void set(quickfix.fix50.component.QuotSetAckGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.QuotSetAckGrp get(quickfix.fix50.component.QuotSetAckGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.QuotSetAckGrp getQuotSetAckGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.QuotSetAckGrp());
	}
	...
	public static class NoQuoteSets extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {302, 311, 312, 309, 305, 457, 462, 463, 310, 763, 313, 542, 241, 242, 243, 244, 245, 246, 256, 595, 592, 593, 594, 247, 316, 941, 317, 436, 435, 308, 306, 362, 363, 307, 364, 365, 877, 878, 318, 879, 810, 882, 883, 884, 885, 886, 887, 972, 975, 973, 974, 998, 1000, 1038, 1058, 1039, 1044, 1045, 1046, 304, 893, 295, 0};
	...
	public void set(quickfix.fix50.component.QuotEntryAckGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.QuotEntryAckGrp get(quickfix.fix50.component.QuotEntryAckGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.QuotEntryAckGrp getQuotEntryAckGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.QuotEntryAckGrp());
	}
	...
	public static class NoQuoteEntries extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {299, 55, 65, 48, 22, 454, 460, 461, 167, 762, 200, 541, 224, 225, 239, 226, 227, 228, 255, 543, 470, 471, 472, 240, 202, 947, 206, 231, 223, 207, 106, 348, 349, 107, 350, 351, 691, 667, 875, 876, 864, 873, 874, 965, 966, 1049, 967, 968, 969, 970, 971, 1018, 996, 997, 1079, 555, 132, 133, 134, 135, 62, 188, 190, 189, 191, 631, 632, 633, 634, 60, 336, 625, 64, 40, 193, 192, 642, 643, 15, 368, 0};
