...
public class MarketDataIncrementalRefresh extends Message {
	...
	public void set(quickfix.fix50.component.MDIncGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.MDIncGrp get(quickfix.fix50.component.MDIncGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.MDIncGrp getMDIncGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.MDIncGrp());
	}
	...
	public static class NoMDEntries extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {279, 285, 269, 278, 280, 55, 65, 48, 22, 454, 460, 461, 167, 762, 200, 541, 224, 225, 239, 226, 227, 228, 255, 543, 470, 471, 472, 240, 202, 947, 206, 231, 223, 207, 106, 348, 349, 107, 350, 351, 691, 667, 875, 876, 864, 873, 874, 965, 966, 1049, 967, 968, 969, 970, 971, 1018, 996, 997, 1079, 711, 555, 291, 292, 270, 15, 271, 272, 273, 274, 275, 336, 625, 276, 277, 282, 283, 284, 286, 59, 432, 126, 110, 18, 287, 37, 299, 288, 289, 346, 290, 546, 811, 451, 58, 354, 355, 528, 1024, 332, 333, 1020, 63, 64, 1070, 83, 1048, 1026, 1027, 1023, 453, 198, 40, 0};
