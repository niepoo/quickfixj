...
public class OrderMassCancelReport extends Message {
	...
	public void set(quickfix.fix50.component.AffectedOrdGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.AffectedOrdGrp get(quickfix.fix50.component.AffectedOrdGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.AffectedOrdGrp getAffectedOrdGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.AffectedOrdGrp());
	}
