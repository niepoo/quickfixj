...
public class CollateralResponse extends Message {
	...
	public CollateralResponse(quickfix.field.CollRespID collRespID, quickfix.field.CollAsgnRespType collAsgnRespType, quickfix.field.TransactTime transactTime) {
		this();
		setField(collRespID);
	...
	public void set(quickfix.fix50.component.ExecCollGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.ExecCollGrp get(quickfix.fix50.component.ExecCollGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.ExecCollGrp getExecCollGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.ExecCollGrp());
	}
	...
	public void set(quickfix.fix50.component.TrdCollGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.TrdCollGrp get(quickfix.fix50.component.TrdCollGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.TrdCollGrp getTrdCollGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.TrdCollGrp());
	}
	...
	public void set(quickfix.fix50.component.UndInstrmtCollGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.UndInstrmtCollGrp get(quickfix.fix50.component.UndInstrmtCollGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.UndInstrmtCollGrp getUndInstrmtCollGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.UndInstrmtCollGrp());
	}
	...
	public static class NoUnderlyings extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {311, 312, 309, 305, 457, 462, 463, 310, 763, 313, 542, 241, 242, 243, 244, 245, 246, 256, 595, 592, 593, 594, 247, 316, 941, 317, 436, 435, 308, 306, 362, 363, 307, 364, 365, 877, 878, 318, 879, 810, 882, 883, 884, 885, 886, 887, 972, 975, 973, 974, 998, 1000, 1038, 1058, 1039, 1044, 1045, 1046, 944, 0};
