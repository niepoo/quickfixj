...
public class Quote extends Message {
	...
	public void set(quickfix.fix50.component.LegQuotGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.LegQuotGrp get(quickfix.fix50.component.LegQuotGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.LegQuotGrp getLegQuotGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.LegQuotGrp());
	}
	...
	public static class NoLegs extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {600, 601, 602, 603, 604, 607, 608, 609, 764, 610, 611, 248, 249, 250, 251, 252, 253, 257, 599, 596, 597, 598, 254, 612, 942, 613, 614, 615, 616, 617, 618, 619, 620, 621, 622, 623, 624, 556, 740, 739, 955, 956, 999, 1001, 687, 690, 587, 588, 683, 539, 686, 681, 684, 676, 677, 678, 679, 680, 685, 654, 1067, 1068, 0};
	...
	public void set(quickfix.field.BidSwapPoints value) {
		setField(value);
	}

	public quickfix.field.BidSwapPoints get(quickfix.field.BidSwapPoints value) throws FieldNotFound {
		getField(value);
		return value;
	}
	...
	public boolean isSet(quickfix.field.BidSwapPoints field) {
		return isSetField(field);
	}

	public boolean isSetBidSwapPoints() {
		return isSetField(1065);
	}

	public void set(quickfix.field.OfferSwapPoints value) {
		setField(value);
	}

	public quickfix.field.OfferSwapPoints get(quickfix.field.OfferSwapPoints value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public quickfix.field.OfferSwapPoints getOfferSwapPoints() throws FieldNotFound {
		return get(new quickfix.field.OfferSwapPoints());
	}

	public boolean isSet(quickfix.field.OfferSwapPoints field) {
		return isSetField(field);
	}

	public boolean isSetOfferSwapPoints() {
