...
public class MarketDataRequest extends Message {
	...
	public void set(quickfix.fix50.component.MDReqGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.MDReqGrp get(quickfix.fix50.component.MDReqGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.MDReqGrp getMDReqGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.MDReqGrp());
	}
	...
	public void set(quickfix.fix50.component.InstrmtMDReqGrp component) {
		setComponent(component);
	}

	public quickfix.fix50.component.InstrmtMDReqGrp get(quickfix.fix50.component.InstrmtMDReqGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.InstrmtMDReqGrp getInstrmtMDReqGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.InstrmtMDReqGrp());
	}
	...
	public static class NoRelatedSym extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {55, 65, 48, 22, 454, 460, 461, 167, 762, 200, 541, 224, 225, 239, 226, 227, 228, 255, 543, 470, 471, 472, 240, 202, 947, 206, 231, 223, 207, 106, 348, 349, 107, 350, 351, 691, 667, 875, 876, 864, 873, 874, 965, 966, 1049, 967, 968, 969, 970, 971, 1018, 996, 997, 1079, 711, 555, 15, 537, 63, 64, 271, 0};
