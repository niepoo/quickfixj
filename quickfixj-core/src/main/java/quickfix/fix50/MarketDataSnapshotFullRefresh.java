...
public class MarketDataSnapshotFullRefresh extends Message {
	...
	public quickfix.fix50.component.MDFullGrp get(quickfix.fix50.component.MDFullGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50.component.MDFullGrp getMDFullGrp() throws FieldNotFound {
		return get(new quickfix.fix50.component.MDFullGrp());
	}
