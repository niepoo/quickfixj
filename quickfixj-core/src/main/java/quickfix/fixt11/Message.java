...
public class Message extends quickfix.Message {
	...
	public void set(quickfix.field.ApplVerID value) {
		setField(value);
	}

	public quickfix.field.ApplVerID get(quickfix.field.ApplVerID value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public quickfix.field.ApplVerID getApplVerID() throws FieldNotFound {
		return get(new quickfix.field.ApplVerID());
	}

	public boolean isSet(quickfix.field.ApplVerID field) {
		return isSetField(field);
	}

	public boolean isSetApplVerID() {
		return isSetField(1128);
	}

	public void set(quickfix.field.ApplExtID value) {
		setField(value);
	}

	public quickfix.field.ApplExtID get(quickfix.field.ApplExtID value) throws FieldNotFound {
		getField(value);
		return value;
	}
	...
	public boolean isSet(quickfix.field.ApplExtID field) {
		return isSetField(field);
	}

	public boolean isSetApplExtID() {
		return isSetField(1156);
	}

	public void set(quickfix.field.CstmApplVerID value) {
		setField(value);
	}

	public quickfix.field.CstmApplVerID get(quickfix.field.CstmApplVerID value) throws FieldNotFound {
		getField(value);
		return value;
	}
	...
	public boolean isSet(quickfix.field.CstmApplVerID field) {
		return isSetField(field);
	}

	public boolean isSetCstmApplVerID() {
		return isSetField(1129);
	}
