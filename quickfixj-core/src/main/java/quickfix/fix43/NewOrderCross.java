...
public class NewOrderCross extends Message {
	...
	public NewOrderCross(quickfix.field.CrossID crossID, quickfix.field.CrossType crossType, quickfix.field.CrossPrioritization crossPrioritization, quickfix.field.HandlInst handlInst, quickfix.field.TransactTime transactTime, quickfix.field.OrdType ordType) {
		this();
		setField(crossID);
		setField(crossType);
	...
	public static class NoSides extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {54, 11, 526, 583, 453, 229, 1, 581, 589, 590, 591, 78, 465, 38, 152, 516, 468, 469, 12, 13, 479, 497, 528, 529, 582, 121, 120, 58, 354, 355, 77, 203, 544, 635, 377, 659, 0};
