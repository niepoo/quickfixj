...
public class NewOrderMultileg extends Message {
	...
	public NewOrderMultileg(quickfix.field.ClOrdID clOrdID, quickfix.field.HandlInst handlInst, quickfix.field.Side side, quickfix.field.TransactTime transactTime, quickfix.field.OrdType ordType) {
		this();
		setField(clOrdID);
		setField(handlInst);
		setField(side);
