...
public class SecurityTypes extends Message {
	...
	public quickfix.field.TotalNumSecurityTypes get(quickfix.field.TotalNumSecurityTypes value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public quickfix.field.TotalNumSecurityTypes getTotalNumSecurityTypes() throws FieldNotFound {
		return get(new quickfix.field.TotalNumSecurityTypes());
	}
	...
	public static class NoSecurityTypes extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {167, 460, 461, 0};
