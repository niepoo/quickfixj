...
public class InstrumentLeg extends quickfix.MessageComponent {
	...
	private int[] componentFields = { 600, 601, 602, 603, 607, 608, 609, 610, 611, 248, 249, 250, 251, 252, 253, 257, 599, 596, 597, 598, 254, 612, 613, 614, 615, 616, 617, 618, 619, 620, 621, 622, 623, 624,  };
	...
	public InstrumentLeg(quickfix.field.LegSymbol legSymbol) {
		this();
		setField(legSymbol);
	}
