...
public class UnderlyingInstrument extends quickfix.MessageComponent {
	...
	private int[] componentFields = { 311, 312, 309, 305, 462, 463, 310, 763, 313, 542, 315, 241, 242, 243, 244, 245, 246, 256, 595, 592, 593, 594, 247, 316, 941, 317, 436, 435, 308, 306, 362, 363, 307, 364, 365, 877, 878, 318, 879, 810, 882, 883, 884, 885, 886, 887,  };
	...
	public UnderlyingInstrument(quickfix.field.UnderlyingSymbol underlyingSymbol) {
		this();
