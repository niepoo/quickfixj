...
public class OrderCancelRequest extends Message {
	...
	public OrderCancelRequest(quickfix.field.OrigClOrdID origClOrdID, quickfix.field.ClOrdID clOrdID, quickfix.field.CxlType cxlType, quickfix.field.Symbol symbol, quickfix.field.Side side, quickfix.field.OrderQty orderQty) {
		this();
	...
	public void set(quickfix.field.CxlType value) {
		setField(value);
	}

	public quickfix.field.CxlType get(quickfix.field.CxlType value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public quickfix.field.CxlType getCxlType() throws FieldNotFound {
		return get(new quickfix.field.CxlType());
	}

	public boolean isSet(quickfix.field.CxlType field) {
		return isSetField(field);
	}
