...
public class NewOrderList extends Message {
	...
	public NewOrderList(quickfix.field.ListID listID, quickfix.field.ListSeqNo listSeqNo, quickfix.field.ListNoOrds listNoOrds, quickfix.field.ClOrdID clOrdID, quickfix.field.HandlInst handlInst, quickfix.field.Symbol symbol, quickfix.field.Side side, quickfix.field.OrderQty orderQty, quickfix.field.OrdType ordType) {
		this();
		setField(listID);
		setField(listSeqNo);
		setField(listNoOrds);
	...
	public quickfix.field.ListNoOrds get(quickfix.field.ListNoOrds value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public quickfix.field.ListNoOrds getListNoOrds() throws FieldNotFound {
		return get(new quickfix.field.ListNoOrds());
	}
