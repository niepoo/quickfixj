...
public class ExecutionReport extends Message {
	...
	public ExecutionReport(quickfix.field.OrderID orderID, quickfix.field.ExecID execID, quickfix.field.ExecTransType execTransType, quickfix.field.OrdStatus ordStatus, quickfix.field.Symbol symbol, quickfix.field.Side side, quickfix.field.OrderQty orderQty, quickfix.field.LastShares lastShares, quickfix.field.LastPx lastPx, quickfix.field.CumQty cumQty, quickfix.field.AvgPx avgPx) {
		this();
		setField(orderID);
		setField(execID);
